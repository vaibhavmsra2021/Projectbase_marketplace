...
import 'package:trumio/model/group_model.dart';
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ExpandedListTile(groupModel:
                  FakeRepository.recentData[index] ,key:new Key("")
                );
              },),
          ),
          SizedBox(height: 10,),
...
class  ExpandedListTile extends StatelessWidget{
  ...
  const ExpandedListTile({required Key key, required this.groupModel}) : super(key: key);
