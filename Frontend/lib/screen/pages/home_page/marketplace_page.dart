            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    buildDropdownButton(
                        'Project Type', ['New', 'Recommended', 'Favorite']),
                ...
                Row(
                  ...
                  children: [
                    ...
                    buildDropdownButton(
                        'Select Skill', ['Java', '3d Studio Max']),
                  ],
                ),
                SizedBox(height: 8.0),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    buildDropdownButton('Select Tools', [
                      'New',
                      'Recommended',
                      'Favorite'
                    ]), //fetching the tools from the available project tools
                  ],
                ),
                ElevatedButton(
                  onPressed: () {
